...
from util import GraphicsWidget, SvgItem
...
class SquareWidget(GraphicsWidget):
    ...
    def addPiece(self, piece):
        ...
        # take up 90% of the square and center the piece
        side = settings.square_size * .9
        piece.scaleTo(side)
        pad = settings.square_size * .1 / 2
        piece.setPos(pad, pad)
...
class PieceItem(SvgItem, GraphicsWidget):
    '''
    ...
    def __init__(self, renderer):
        super(PieceItem, self).__init__(None, renderer=renderer)
